...
const ProductSection = () => {
  return(
    <section className="px-44 py-20">
      <section className="px-32 md:px-32 text-center mb-20">
      ...
      <div className="space-y-28">
        <ProductInfo heading={"Accounting Software"} imgSrc={accImg} imgAlt={"Accounting Software Screens"} style={" md:flex-row-reverse"}>
        ...
        <ProductInfo heading={"HR Software"} imgSrc={accImg} imgAlt={"Accounting Software Screens"} style={"md:flex-row "}>
        ...
        <ProductInfo heading={"School Management Software"} imgSrc={accImg} imgAlt={"Accounting Software Screens"} style={"md:flex-row-reverse "}>
